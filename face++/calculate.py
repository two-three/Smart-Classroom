...
def judge_time():
    ...
    if ((t.tm_hour == 8 and t.tm_min <= 45) or
        ((t.tm_hour == 8 and t.tm_min >= 50) or (t.tm_hour == 9 and t.tm_min <= 35))):
        nowtime += '第一节'
    elif (((t.tm_hour == 9 and t.tm_min >= 50) or (t.tm_hour == 10 and t.tm_min <= 35)) or
         ((t.tm_hour == 10 and t.tm_min >= 40) or (t.tm_hour == 11 and t.tm_min <= 25))):
        nowtime += '第二节'
    elif ((t.tm_hour == 14 and t.tm_min <= 45) or
         ((t.tm_hour == 14 and t.tm_min >= 50) or (t.tm_hour == 15 and t.tm_min <= 35))):
        nowtime += '第三节'
    elif (((t.tm_hour == 15 and t.tm_min >= 50) or (t.tm_hour == 16 and t.tm_min <= 35)) or
         ((t.tm_hour == 16 and t.tm_min >= 40) or (t.tm_hour == 17 and t.tm_min <= 25))):
        nowtime += '第四节'
    elif (((t.tm_hour == 18 and t.tm_min >= 30) or (t.tm_hour == 19 and t.tm_min <= 15)) or
         ((t.tm_hour == 19 and t.tm_min >= 20) or (t.tm_hour == 20 and t.tm_min <= 5)) or
         ((t.tm_hour == 20 and t.tm_min >= 10) or (t.tm_hour == 20 and t.tm_min <= 55))):
        nowtime += '第五节'
